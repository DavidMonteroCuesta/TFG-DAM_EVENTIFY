...
abstract class AppColors extends AppColorPalette {
  static const Color primary = AppColorPalette.green;
  static const Color secondary = AppColorPalette.greenAccent;
  ...
  static const Color inputFillColor = Color.fromARGB(255, 68, 31, 31);
  ...
  static const Color focusedBorderGreen = AppColorPalette.color69F0AE;
  static const Color editIconColor = AppColorPalette.blueAccent;
  static const Color calendarAccentColor = AppColorPalette.orangeAccent;
  static const Color notificationOrange = AppColorPalette.orange;
  static const Color snackBarInfoColor = AppColorPalette.blueGrey;

  static const Color deleteButtonColor = AppColorPalette.red;
  ...
  static const Color priorityTextColor = AppColorPalette.yellow;
  ...
  static const Color priorityCriticalColor = AppColorPalette.red;
  static const Color priorityHighColor = AppColorPalette.orange;
  static const Color priorityMediumColor = AppColorPalette.yellow;
  static const Color priorityLowColor = AppColorPalette.green;
