...
class EventRemoteDataSource {
  ...
  // Now returns the document ID generated by Firestore
  Future<String> addEvent(String userId, Map<String, dynamic> eventData) async {
    try {
      // Add the event data. Firestore will automatically generate an ID.
  ...
  // Always includes the document ID in the returned map
